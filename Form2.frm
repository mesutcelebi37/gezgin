...
'Terminal deðiþkene atýlýyor.
terminal = "T0" 'dict.Item("term")
DTPicker3.Value = "01.01." & Year(Date)
DTPicker4.Value = "31.12." & Year(Date)

DTPicker1.Value = Format(Date, "dd/mm/YYYY")
DTPicker2.Value = Format(Date, "dd/mm/YYYY")


'harkod = Split(Replace(dict.Item("harKod"), """", ""), ",")

cboMust.AddItem "Tümü"
cboMust.ListIndex = 0
cboHarkod.AddItem "Tümü"
cboHarkod.ListIndex = 0
...
'FÝRMA BÝLGÝLERÝNÝ ALALIM
SQL = "SELECT *FROM ayarlar WHERE adi='odbc' AND kodu='firma'"
rs1.Open SQL, con1, adOpenStatic, adLockReadOnly
firma = rs1![degeri]
...
Me.Caption = " Vers: " & vers
 
'ACCES BAÐLANTI KAPATILIYOR.
con1_kapat


'Sipariþi olan müþterileri çaðýr
Call acik_musteriler
Call hareket_kodlari
End Sub
